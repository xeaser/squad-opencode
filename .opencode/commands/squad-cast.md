...
5. After confirmation, update `.squad/team.md` if needed, run `squad-oc recast` so OpenCode agents match, and remind them they can use `@frontend`, `@backend`, `@tester`, `@lead`.
